...
public class ConversationState {
  ...
  @Getter @Setter private String lastStartedWorkflowId;
  @Getter @Setter private String lastRespondedWorkflowId;
  @Getter @Setter private long latestWorkflowSequence;
