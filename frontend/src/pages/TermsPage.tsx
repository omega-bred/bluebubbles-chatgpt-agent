    ...
    <div className="account-shell">
      ...
      <main className="account-main narrow terms-main">
        ...
        <article className="terms-content">
          ...
          <section>
            <h2>Optional Group Memory</h2>
            <p>
              An eligible participant may enable group memory for a conversation they participate
              in. The service will announce the change in that group and process future messages to
              create shared summaries and memory. Only enable this feature when you are authorized
              to do so and the other participants have received the notice. An eligible participant
              may later disable future collection through the conversation settings.
            </p>
            <p>
              Group summaries and catch-ups are generated by AI and can be incomplete, delayed, or
              wrong. A displayed coverage time describes how far processing has progressed; it is
              not a promise that every message was captured or that the service knows what you have
              personally read. Do not treat a catch-up as an authoritative record of the group.
            </p>
          </section>
